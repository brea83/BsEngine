...
namespace Pixie
{
	UniformBuffer::UniformBuffer(uint32_t sizeOfData, uint32_t glEnumUsage, const std::string& uniformBlockName, std::vector<uint32_t> shaderIDs)
	{
		...
		glBindBufferRange(GL_UNIFORM_BUFFER, 0, m_UniformBufferID, 0, sizeOfData);
	}
